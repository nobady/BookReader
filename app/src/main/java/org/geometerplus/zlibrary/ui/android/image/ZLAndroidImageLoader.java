...
class ZLAndroidImageLoader {
    ...
    private class ImageSynchronizedHandler extends Handler {
        public ImageSynchronizedHandler(Looper looper) {
            super(looper);
        }
    ...
    private final ImageSynchronizedHandler myImageSynchronizedHandler = new ImageSynchronizedHandler(Looper.getMainLooper());
}
