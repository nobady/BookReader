...
public abstract class ZLTextView extends ZLTextViewBase {
    ...
    public final synchronized PagePosition pagePosition(PageIndex pageIndex) {
        if (pageIndex == null) {
            pageIndex = PageIndex.current;
        }
        int current = computeTextPageNumber(getCurrentCharNumber(pageIndex, false));
    ...
    private ZLTextLineInfo processTextLine(
        ...
        if (isFirstLine) {
            info.LeftIndent += getTextStyle().getFirstLineIndentDelta() * getContext().getCharWidth();
        }
