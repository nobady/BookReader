    ...
    public static String languageByIntCode(int languageCode, int subLanguageCode) {
        switch (languageCode) {
            ...
            case 0x2D:
                return "eu";  // Basque
            case 0x2E:
                return (subLanguageCode == 0x08)
                        ? "dsb"          // Lower Sorbian
                        : "wen";         // Upper Sorbian
            case 0x2F:
                return "mk";  // Makedonian
            case 0x32:
                return "tn";  // Setswana/Tswana
            case 0x34:
                return "xh";  // Xhosa/isiXhosa
            case 0x35:
                return "zu";  // Zulu/isiZulu
            case 0x36:
                return "af";  // Afrikaans
            case 0x37:
                return "ka";  // Georgian
            ...
            case 0x6B:
                return "quz"; // Quechua
            case 0x6C:
                return "ns";  // Northern Sotho
            case 0x6D:
                return "ba";  // Bashkir
            case 0x6E:
                return "lb";  // Luxemburgish
            case 0x6F:
