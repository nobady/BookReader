...
public abstract class ZLApplication {
    ...
    protected void runWithMessage(String key, Runnable runnable, Runnable postAction) {
        UIUtil.runWithMessage(key, runnable, postAction, false);
    }

    protected void runWithoutMessage(final Runnable runnable) {
    ...
    public ZLAndroidWidget getViewWidget() {
        return mAndroidWidget;
    }

    private ZLAndroidWidget mAndroidWidget;

    public void setViewWidget(ZLAndroidWidget widget) {
        mAndroidWidget = widget;
    }
