...
public final class FBReaderApp extends ZLApplication {
...

    {
        ...
        TopMarginOption = new ZLIntegerRangeOption("Options", "TopMargin", 0, 100, horMargin);
        ...
        FooterHeightOption = new ZLIntegerRangeOption("Options", "FooterHeight", 8, dpi / 8, dpi / 10);
    }
    ...
    public FBReaderApp() {
        IBookCollection collection = BookManager.getInstance();
    ...
    public void openBook(final Book book, final Bookmark bookmark, final Runnable postAction) {
        if (book != null || Model == null) {
            runWithoutMessage(new Runnable() {
                public void run() {
    ...
    public void setTextColor(int color) {
        getColorProfile().RegularTextOption.setValue(new ZLColor(color));
    }
