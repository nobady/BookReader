...
public final class FBView extends ZLTextView {
    ...
    public boolean onFingerRelease(int x, int y, float xVelocity, float yVelocity) {
        if (super.onFingerRelease(x, y, xVelocity, yVelocity)) {
            return true;
        }
        ...
        if (isFlickScrollingEnabled()) {
            myReader.getViewWidget().startAnimatedScrolling(
                    x, y, xVelocity, yVelocity, myReader.PageTurningOptions.AnimationSpeed.getValue()
            );
            return true;
        }
    ...
    public ZLColor getTextColor(ZLTextHyperlink hyperlink) {
        ...
        switch (hyperlink.Type) {
            ...
            case FBHyperlinkType.NONE:
                return new ZLColor(ReaderSettings.getInstance().getTextColor());
    ...
    private class Footer implements DrawArea {
        ...
        public int getHeight() {
            return myReader.FooterHeightOption.getValue() + getTopMargin();
        }
        ...
        public synchronized void paint(ZLPaintContext context) {
            ...
            final ZLColor fgColor = new ZLColor(ReaderSettings.getInstance().getSecondaryTextColor());
            ...
            final PagePosition pagePosition = FBView.this.pagePosition(mPageIndex);
            ...
            if (reader.FooterOptions.ShowBattery.getValue()) {
                ...
                sb.append(BatteryUtil.getBatteryLevel());
                sb.append("%");
            }
            ...
            context.drawString(left, height / 2, sb.toString());
            ...
            final String infoString = sb.toString();
            final int infoWidth = context.getStringWidth(infoString);
            context.drawString(right - infoWidth, height / 2, infoString);
        }
    ...
    private class Header implements DrawArea {
        ...
        public synchronized void paint(ZLPaintContext context) {
            ...
            final String infoString = model.Book.getTitle();

            // draw info text
            context.setTextColor(fgColor);
            context.drawString(left, getHeight(), infoString);
        }
