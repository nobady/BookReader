...
public class LibraryService extends Service {
    ...
    public void onStart(Intent intent, int startId) {
        Log.v("FBReader", "LibraryService onStart");
        onStartCommand(intent, 0, startId);
    }

    @Override
    public int onStartCommand(Intent intent, int flags, int startId) {
        Log.v("FBReader", "LibraryService onStartCommand");
        return START_STICKY;
    }

    @Override
    public IBinder onBind(Intent intent) {
        Log.v("FBReader", "LibraryService onBind");
        return myLibrary;
    }

    @Override
    public void onCreate() {
        Log.v("FBReader", "LibraryService onCreate");
        super.onCreate();
    ...
    public void onDestroy() {
        Log.v("FBReader", "LibraryService onDestroy");
        if (myLibrary != null) {
