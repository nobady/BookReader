...
public class PreferenceActivity extends ZLPreferenceActivity {
    private IBookCollection myCollection = BookManager.getInstance();
...
//        final FBReaderApp fbReader = (FBReaderApp) FBReaderApp.Instance();
        final FBReaderApp fbReader = new FBReaderApp();
        ...
        directoriesScreen.addPreference(new ZLStringOptionPreference(
            ...
            protected void setValue(String value) {
                ...
                // TODO: Since this operation change the root directory of books,
                // We need to recreate BookCollection.
