 ...
 */
public class OnlineBooksAdapter extends BucketListAdapter<BookItem> {
    private LayoutInflater mInflater;
    private Context mContext;

    public OnlineBooksAdapter(Context context) {
    ...
    protected View newView(int position, BookItem element) {
        ...
        viewHolder.mStatusImageView = (ImageView) view.findViewById(R.id.finish);
    ...
    protected void bindView(View view, int position, BookItem element) {
        ...
        if (element.isFinish() ) {
            viewHolder.mStatusImageView.setImageResource(R.drawable.finish);
        } else {
            viewHolder.mStatusImageView.setImageResource(R.drawable.unfinished);
        }
    }
