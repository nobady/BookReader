 ...
 *******************************************************************************/
package com.sanqiwan.reader.pulltorefresh.extras.listfragment;
...
abstract class PullToRefreshBaseListFragment<T extends PullToRefreshBase<? extends AbsListView>> extends ListFragment {
    ...
    /**
     * @return The {@link com.handmark.pulltorefresh.library.PullToRefreshBase} attached to this ListFragment.
     */
    ...
    /**
     * Returns the {@link com.handmark.pulltorefresh.library.PullToRefreshBase} which will replace the ListView
     * created from ListFragment. You should override this method if you wish to
     * customise the {@link com.handmark.pulltorefresh.library.PullToRefreshBase} from the default.
     *
     ...
     *                           onCreateView(...)}
     * @return The {@link com.handmark.pulltorefresh.library.PullToRefreshBase} which will replace the ListView.
     */
