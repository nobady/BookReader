...
public interface IPullToRefresh<T extends View> {
    ...
    /**
     * Get the mode that this com.sanqiwan.view is currently in. This is only really useful
     * when using <code>Mode.BOTH</code>.
     *
     * @return Mode that the com.sanqiwan.view is currently in
     */
    ...
    /**
     * Get the mode that this com.sanqiwan.view has been set to. If this returns
     * <code>Mode.BOTH</code>, you can use <code>getCurrentMode()</code> to
     * check which mode the com.sanqiwan.view is currently in
     *
     * @return Mode that the com.sanqiwan.view has been set to
     */
    public Mode getMode();

    /**
     * Get the Wrapped Refreshable View. Anything returned here has already been
     * added to the content com.sanqiwan.view.
     *
    ...
    /**
     * Set the mode of Pull-to-Refresh that this com.sanqiwan.view will use.
     *
     ...
     * show the 'Refreshing' com.sanqiwan.view, and be scrolled to show such.
     */
    public void setRefreshing();

    /**
     * Sets the Widget to be in the refresh state. The UI will be updated to
     * show the 'Refreshing' com.sanqiwan.view.
     *
