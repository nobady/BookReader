...
import com.sanqiwan.reader.pulltorefresh.library.internal.*;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    /**
     * @return Either {@link com.handmark.pulltorefresh.library.PullToRefreshBase.Orientation#VERTICAL} or
     *         {@link com.handmark.pulltorefresh.library.PullToRefreshBase.Orientation#HORIZONTAL} depending on the scroll direction.
     */
    ...
    /**
     * Used internally for adding com.sanqiwan.view. Need because we override addView to
     ...
     * <p/>
     * Be sure to set the ID of the com.sanqiwan.view in this method, especially if you're
     * using a ListActivity or ListFragment.
     *
     * @param context Context to create com.sanqiwan.view with
     ...
     * {@link com.handmark.pulltorefresh.library.PullToRefreshBase.State#PULL_TO_REFRESH} state.
     */
    ...
    /**
     * Called when the UI has been to be updated to be in the
     * {@link com.handmark.pulltorefresh.library.PullToRefreshBase.State#RELEASE_TO_REFRESH} state.
     */
    ...
    /**
     * Called when the UI has been to be updated to be in the
     * {@link com.handmark.pulltorefresh.library.PullToRefreshBase.State#RESET} state.
     */
    ...
    public static enum AnimationStyle {
         ...
         * inflating the com.sanqiwan.view from XML where the mode is given through a attr
         * int.
         *
    ...
    public static enum Mode {
         ...
         * {@link com.handmark.pulltorefresh.library.PullToRefreshBase#setRefreshing() setRefreshing()}.
         */
